...
const articles = [
  {
    title: "제1조(목적)",
    paragraphs: [
      "이 약관은 주식회사 코그로보(전자상거래 사업자)가 운영하는 코그로보 GPU 호스팅몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.",
  ...
  },
  {
    title: "제2조(정의)",
    paragraphs: [
      "① “몰”이란 주식회사 코그로보가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.",
    ...
    content: (
      <div className="space-y-8">
        ...
        <div className="border-t border-[#ececec] pt-6">
          <h3 className="font-semibold text-[#1f1f1f]">부칙 (2023.06.12)</h3>
          <p className="mt-3">
            이 약관은 2023년 06월 12일부터 시행하며 종전의 약관은 이 약관으로
            대체합니다.
          </p>
        </div>
      </div>
