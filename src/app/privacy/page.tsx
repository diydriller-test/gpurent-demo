...
const articles = [
  {
    title: "시행일",
    paragraphs: ["2023-06-12"],
  },
  {
    title: "개인정보처리방침 안내",
    paragraphs: [
      "주식회사 코그로보는 (이하 “회사”는) 고객님의 개인정보를 중요시하며, 「개인정보 보호법」 등 관련 법령을 준수하고 있습니다.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "o 위탁 대상자 : 카페24페이먼츠 (PG사)",
      "o 위탁업무 내용 : 대금결제시 수집하는 개인정보는 결제대행업체(PG사)에서 수집 및 저장하고 있으며, 회사는 결제대행업체에서 제공하는 거래내역만을 제공받고 있습니다.",
      "o 위탁 대상자 : 공급업체 목록보기",
      "o 위탁업무 내용 : 미정",
    ],
  },
