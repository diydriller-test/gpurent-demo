...
const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  {
    q: "입력한 프롬프트나 개인정보, 이미지 등의 데이터가 저장되나요?",
    a: "아닙니다. 로그인 사용자 정보 외에 일체의 개인정보, 사용자 로그, 프롬프트 등을 저장하지 않습니다. 제공 중인 API 9종 모두 별도의 저장(storage) 기능을 두고 있지 않아 요청 처리 후 어떠한 데이터도 서버에 남지 않습니다.",
  },
  {
    q: "업로드한 파일은 어떻게 처리되며, 삭제가 가능한가요?",
    a: "업로드하신 파일은 처리에 필요한 동안에만 임시(temp) 저장된 후 사용 즉시 삭제되어 보관되지 않습니다. 별도의 삭제 요청 절차 없이도 모든 업로드 파일은 호출 종료와 함께 자동으로 폐기됩니다.",
  },
  {
